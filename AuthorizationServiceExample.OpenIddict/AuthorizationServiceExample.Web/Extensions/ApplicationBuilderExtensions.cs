using AuthorizationServiceExample.Web.Middlewares;
using AuthorizationServiceExample.Web.Middlewares.Csp;

namespace AuthorizationServiceExample.Web.Extensions;
...
internal static class ApplicationBuilderExtensions
{
    ...
    internal static IApplicationBuilder UseDefaultContentSecurityPolicy(this IApplicationBuilder app, IWebHostEnvironment env)
    {
        app.UseContentSecurityPolicy(options =>
        {
            ...
            options.AddDirective(CspDirectives.ConnectFetchDirective, CspSources.SelfSources);
